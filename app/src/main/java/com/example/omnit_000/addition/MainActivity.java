package com.example.omnit_000.addition;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    public Button adder;
    public EditText edFirst;
    public EditText edSecond;
    ...
    public void onClick(View v) {
        int val1 = Integer.parseInt(edFirst.getText().toString());
        int val2 = Integer.parseInt(edSecond.getText().toString());
